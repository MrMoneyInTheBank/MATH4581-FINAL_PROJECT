...
class TestViterbi(unittest.TestCase):
    ...
    def test_viterbi(self):
        ...
        steady_state_prob_one = find_steady_state_prob(fixed_vector_one, states_one)
        ...
        steady_state_prob_two = find_steady_state_prob(fixed_vector_two, states_two)
        ...
        observations_three = ["red", "black", "red", "red", "red", "black", "red"]

        fixed_vector_three = find_fixed_vector(tran_matrix_three)   
        steady_state_prob_three = find_steady_state_prob(fixed_vector_three, states_three)
